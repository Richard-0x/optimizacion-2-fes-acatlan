...
\date{\today}
\institute{\url{acatlan.unam.com.mx}}
...
\begin{frame}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{p{4.5cm} l l p{3.5cm}}
            ...
            \midrule
            \textbf{Resolución Algorítmica 1} & \textbf{Ricardo López} & \textbf{Dijkstra y Modelo de PL} & Diapositivas \\
            \midrule
            \textbf{Resolución Algorítmica 2} & \textbf{Emiliano Sánchez} & \textbf{Floyd-Warshall} & Diapositivas \\
            \midrule
            Análisis de Sensibilidad (What-If) & Ricardo y Emiliano & Dijkstra iterativo & Diapositivas \\
            \midrule
